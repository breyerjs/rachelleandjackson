        ...
        return (
            <div>
                ...
                <div className={styles.travelSection}>
                    ...
                    <br /><br />
                    The venue is located in the Marin Headlands National Park, just across the Golden Gate Bridge from San Francisco. Just down the street is Rodeo Beach, where you'll find great spots for hiking and relaxing. 
                </div>
                <div className={styles.travelSection}>
